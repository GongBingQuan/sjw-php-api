...
class User extends Controller
{
     ...
     * 商户列表
     */
    public function index($keyword='',$mobile='',$nickName = '', $gender = null, $reg_date = '', $grade_id = null)
    {
        if($keyword){
            $nickName =  $keyword;
            $mobile = $keyword;
        }
        $list = UserModel::getList($nickName, $grade_id, $reg_date,$mobile, $gender = -1, $this->postData());
