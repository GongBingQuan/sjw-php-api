...
class ShopService
{
    ...
    public function getHomeData()
    {
        ...
        return [
            ...
            'right_away' => [
                ...
                //提现
                'cash' => [
                    'percentage' => $this->getAgentOrderTotal(),
                ],
                //审核
                'review' => [
                    'percentage' => $this->getAgentApplyTotal(),
    ...
    {
        $model = new CashModel;
        return number_format($model->getAgentCashTotal());
    }

    /**
     * 获取待审核提现总数量
     */
    private function getAgentApplyTotal()
    {
        $model = new CashModel;
        return number_format($model->getAgentApplyTotal());
    }
