...
class Order extends BaseModel
{
    ...
    {
        return $this->hasMany('app\\common\\model\\order\\OrderApply', 'order_id', 'order_id');
    }
    ...
    {
        return $this->hasOne('app\\common\\model\\user\\Company','company_id',"company_id");
    }
...
//        }
     ...
     * 订单详情
     */
    public static function detail($where, $with = ['user', 'address','company', 'product' => ['image', 'refund'],'apply', 'extract', 'express', 'extractStore.logo', 'extractClerk'])
    {
